...
class Template
{
    ...
    * @param mixed $mail
    */
    public static function save_registered_email($mail)
    {
        Session::set('registered_email', $mail);
        Session::save();
    }
    
    public static function get_registered_email()
    {
        return Session::get('registered_email');
    }
